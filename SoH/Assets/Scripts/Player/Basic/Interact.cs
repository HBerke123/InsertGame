...
public class Interact : MonoBehaviour
{
    ...
    {
        if (collision.GetComponent<InteractiveArea>() && (interactiveArea == null) && (collision.GetComponent<InteractiveArea>().enabled == true))
        {
            interactiveArea = collision.GetComponent<InteractiveArea>();
        }
    }
